...
public interface UserHistoryMapper {
     ...
     * @return PhotoDto
     */
    List<PhotoDto> getUserRecentPosts(@Param("userId" )String userId, @Param("limit") int limit);
     ...
     */
    List<ContestResultDto> getUserContestResults(@Param("userId") String userId);
